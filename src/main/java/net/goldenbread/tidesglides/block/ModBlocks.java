package net.goldenbread.tidesglides.block;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(TidesAndGlides.MOD_ID);

    public static final DeferredBlock<Block> BLACK_SAND = registerBlock("black_sand",
            () -> new Block(BlockBehaviour.Properties.of()
                    .sound(SoundType.SAND).strength(0.5f).instrument(NoteBlockInstrument.SNARE)));
